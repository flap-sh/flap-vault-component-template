...
- Create new Vault packages with `yarn vault:scaffold <folder-name> --chain 56 --factory 0x...`. Repeat `--chain N --factory 0x...` for each deployment target (mainnet, testnet, etc.).
