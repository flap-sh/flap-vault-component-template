...
| `mode` | Optional | Omit for the default Vault UI. Use `mini-app` only for token-scoped 8888-token Mini App artifacts; it skips the Vault risk-status tag checks. |
