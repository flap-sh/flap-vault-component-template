...
7. Gather inputs:
   ...
   - at least one manifest test token stored per binding as `match.bindings[].tokenAddresses`; manifest-provided no-factory mappings may contain multiple tokens
