...
10. For a new package, prefer `yarn vault:scaffold {folder-name} --name "..." --chain 56 --factory 0x... [--chain 97 --factory 0x...] --locales ...` before implementation. Add one `--chain / --factory` pair per deployment target.
