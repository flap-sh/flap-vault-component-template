...
7. Gather inputs:
   ...
   - real deployed `7777`-suffix token values for any `match.bindings[].tokenAddresses`; do not treat factory-mode `tokenAddresses` as production CA restrictions
