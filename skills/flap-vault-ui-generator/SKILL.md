...
7. Gather inputs:
   ...
   - optional token CA lists only when needed, stored per binding as `match.bindings[].tokenAddresses`; manifest-provided no-factory mappings may contain multiple tokens
